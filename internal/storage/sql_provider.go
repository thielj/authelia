...
func NewSQLProvider(config *schema.Configuration, name, driverName, schema, dataSourceName string) (provider SQLProvider) {
	...
	provider = SQLProvider{
		...
		sqlInsertAuthenticationAttempt:            fmtQuery(queryFmtInsertAuthenticationLogEntry, tableAuthenticationLogs, name, schema),
		sqlSelectAuthenticationAttemptsByUsername: fmtQuery(queryFmtSelect1FAAuthenticationLogEntryByUsername, tableAuthenticationLogs, name, schema),

		sqlInsertIdentityVerification:  fmtQuery(queryFmtInsertIdentityVerification, tableIdentityVerification, name, schema),
		sqlConsumeIdentityVerification: fmtQuery(queryFmtConsumeIdentityVerification, tableIdentityVerification, name, schema),
		sqlRevokeIdentityVerification:  fmtQuery(queryFmtRevokeIdentityVerification, tableIdentityVerification, name, schema),
		sqlSelectIdentityVerification:  fmtQuery(queryFmtSelectIdentityVerification, tableIdentityVerification, name, schema),

		sqlInsertOneTimeCode:            fmtQuery(queryFmtInsertOTC, tableOneTimeCode, name, schema),
		sqlConsumeOneTimeCode:           fmtQuery(queryFmtConsumeOTC, tableOneTimeCode, name, schema),
		sqlRevokeOneTimeCode:            fmtQuery(queryFmtRevokeOTC, tableOneTimeCode, name, schema),
		sqlSelectOneTimeCode:            fmtQuery(queryFmtSelectOTCBySignatureAndUsername, tableOneTimeCode, name, schema),
		sqlSelectOneTimeCodeBySignature: fmtQuery(queryFmtSelectOTCBySignature, tableOneTimeCode, name, schema),
		sqlSelectOneTimeCodeByID:        fmtQuery(queryFmtSelectOTCByID, tableOneTimeCode, name, schema),
		sqlSelectOneTimeCodeByPublicID:  fmtQuery(queryFmtSelectOTCByPublicID, tableOneTimeCode, name, schema),

		sqlUpsertTOTPConfig:  fmtQuery(queryFmtUpsertTOTPConfiguration, tableTOTPConfigurations, name, schema),
		sqlDeleteTOTPConfig:  fmtQuery(queryFmtDeleteTOTPConfiguration, tableTOTPConfigurations, name, schema),
		sqlSelectTOTPConfig:  fmtQuery(queryFmtSelectTOTPConfiguration, tableTOTPConfigurations, name, schema),
		sqlSelectTOTPConfigs: fmtQuery(queryFmtSelectTOTPConfigurations, tableTOTPConfigurations, name, schema),

		sqlUpdateTOTPConfigRecordSignIn:           fmtQuery(queryFmtUpdateTOTPConfigRecordSignIn, tableTOTPConfigurations, name, schema),
		sqlUpdateTOTPConfigRecordSignInByUsername: fmtQuery(queryFmtUpdateTOTPConfigRecordSignInByUsername, tableTOTPConfigurations, name, schema),

		sqlInsertTOTPHistory: fmtQuery(queryFmtInsertTOTPHistory, tableTOTPHistory, name, schema),
		sqlSelectTOTPHistory: fmtQuery(queryFmtSelectTOTPHistory, tableTOTPHistory, name, schema),

		sqlInsertWebAuthnUser: fmtQuery(queryFmtInsertWebAuthnUser, tableWebAuthnUsers, name, schema),
		sqlSelectWebAuthnUser: fmtQuery(queryFmtSelectWebAuthnUser, tableWebAuthnUsers, name, schema),

		sqlInsertWebAuthnCredential:                           fmtQuery(queryFmtInsertWebAuthnCredential, tableWebAuthnCredentials, name, schema),
		sqlSelectWebAuthnCredentials:                          fmtQuery(queryFmtSelectWebAuthnCredentials, tableWebAuthnCredentials, name, schema),
		sqlSelectWebAuthnCredentialsByUsername:                fmtQuery(queryFmtSelectWebAuthnCredentialsByUsername, tableWebAuthnCredentials, name, schema),
		sqlSelectWebAuthnCredentialsByRPIDByUsername:          fmtQuery(queryFmtSelectWebAuthnCredentialsByRPIDByUsername, tableWebAuthnCredentials, name, schema),
		sqlSelectWebAuthnCredentialByID:                       fmtQuery(queryFmtSelectWebAuthnCredentialByID, tableWebAuthnCredentials, name, schema),
		sqlUpdateWebAuthnCredentialDescriptionByUsernameAndID: fmtQuery(queryFmtUpdateUpdateWebAuthnCredentialDescriptionByUsernameAndID, tableWebAuthnCredentials, name, schema),
		sqlUpdateWebAuthnCredentialRecordSignIn:               fmtQuery(queryFmtUpdateWebAuthnCredentialRecordSignIn, tableWebAuthnCredentials, name, schema),
		sqlDeleteWebAuthnCredential:                           fmtQuery(queryFmtDeleteWebAuthnCredential, tableWebAuthnCredentials, name, schema),
		sqlDeleteWebAuthnCredentialByUsername:                 fmtQuery(queryFmtDeleteWebAuthnCredentialByUsername, tableWebAuthnCredentials, name, schema),
		sqlDeleteWebAuthnCredentialByUsernameAndDisplayName:   fmtQuery(queryFmtDeleteWebAuthnCredentialByUsernameAndDescription, tableWebAuthnCredentials, name, schema),

		sqlUpsertDuoDevice: fmtQuery(queryFmtUpsertDuoDevice, tableDuoDevices, name, schema),
		sqlDeleteDuoDevice: fmtQuery(queryFmtDeleteDuoDevice, tableDuoDevices, name, schema),
		sqlSelectDuoDevice: fmtQuery(queryFmtSelectDuoDevice, tableDuoDevices, name, schema),

		sqlUpsertPreferred2FAMethod: fmtQuery(queryFmtUpsertPreferred2FAMethod, tableUserPreferences, name, schema),
		sqlSelectPreferred2FAMethod: fmtQuery(queryFmtSelectPreferred2FAMethod, tableUserPreferences, name, schema),
		...
		sqlInsertUserOpaqueIdentifier:            fmtQuery(queryFmtInsertUserOpaqueIdentifier, tableUserOpaqueIdentifier, name, schema),
		sqlSelectUserOpaqueIdentifier:            fmtQuery(queryFmtSelectUserOpaqueIdentifier, tableUserOpaqueIdentifier, name, schema),
		sqlSelectUserOpaqueIdentifiers:           fmtQuery(queryFmtSelectUserOpaqueIdentifiers, tableUserOpaqueIdentifier, name, schema),
		sqlSelectUserOpaqueIdentifierBySignature: fmtQuery(queryFmtSelectUserOpaqueIdentifierBySignature, tableUserOpaqueIdentifier, name, schema),

		sqlUpsertOAuth2BlacklistedJTI: fmtQuery(queryFmtUpsertOAuth2BlacklistedJTI, tableOAuth2BlacklistedJTI, name, schema),
		sqlSelectOAuth2BlacklistedJTI: fmtQuery(queryFmtSelectOAuth2BlacklistedJTI, tableOAuth2BlacklistedJTI, name, schema),

		sqlInsertOAuth2PARContext: fmtQuery(queryFmtInsertOAuth2PARContext, tableOAuth2PARContext, name, schema),
		sqlUpdateOAuth2PARContext: fmtQuery(queryFmtUpdateOAuth2PARContext, tableOAuth2PARContext, name, schema),
		sqlSelectOAuth2PARContext: fmtQuery(queryFmtSelectOAuth2PARContext, tableOAuth2PARContext, name, schema),
		sqlRevokeOAuth2PARContext: fmtQuery(queryFmtRevokeOAuth2Session, tableOAuth2PARContext, name, schema),

		sqlInsertOAuth2ConsentPreConfiguration:  fmtQuery(queryFmtInsertOAuth2ConsentPreConfiguration, tableOAuth2ConsentPreConfiguration, name, schema),
		sqlSelectOAuth2ConsentPreConfigurations: fmtQuery(queryFmtSelectOAuth2ConsentPreConfigurations, tableOAuth2ConsentPreConfiguration, name, schema),

		sqlInsertOAuth2ConsentSession:              fmtQuery(queryFmtInsertOAuth2ConsentSession, tableOAuth2ConsentSession, name, schema),
		sqlUpdateOAuth2ConsentSessionSubject:       fmtQuery(queryFmtUpdateOAuth2ConsentSessionSubject, tableOAuth2ConsentSession, name, schema),
		sqlUpdateOAuth2ConsentSessionResponse:      fmtQuery(queryFmtUpdateOAuth2ConsentSessionResponse, tableOAuth2ConsentSession, name, schema),
		sqlUpdateOAuth2ConsentSessionGranted:       fmtQuery(queryFmtUpdateOAuth2ConsentSessionGranted, tableOAuth2ConsentSession, name, schema),
		sqlSelectOAuth2ConsentSessionByChallengeID: fmtQuery(queryFmtSelectOAuth2ConsentSessionByChallengeID, tableOAuth2ConsentSession, name, schema),

		sqlInsertOAuth2AccessTokenSession:                fmtQuery(queryFmtInsertOAuth2Session, tableOAuth2AccessTokenSession, name, schema),
		sqlSelectOAuth2AccessTokenSession:                fmtQuery(queryFmtSelectOAuth2Session, tableOAuth2AccessTokenSession, name, schema),
		sqlRevokeOAuth2AccessTokenSession:                fmtQuery(queryFmtRevokeOAuth2Session, tableOAuth2AccessTokenSession, name, schema),
		sqlRevokeOAuth2AccessTokenSessionByRequestID:     fmtQuery(queryFmtRevokeOAuth2SessionByRequestID, tableOAuth2AccessTokenSession, name, schema),
		sqlDeactivateOAuth2AccessTokenSession:            fmtQuery(queryFmtDeactivateOAuth2Session, tableOAuth2AccessTokenSession, name, schema),
		sqlDeactivateOAuth2AccessTokenSessionByRequestID: fmtQuery(queryFmtDeactivateOAuth2SessionByRequestID, tableOAuth2AccessTokenSession, name, schema),

		sqlInsertOAuth2AuthorizeCodeSession:                fmtQuery(queryFmtInsertOAuth2Session, tableOAuth2AuthorizeCodeSession, name, schema),
		sqlSelectOAuth2AuthorizeCodeSession:                fmtQuery(queryFmtSelectOAuth2Session, tableOAuth2AuthorizeCodeSession, name, schema),
		sqlRevokeOAuth2AuthorizeCodeSession:                fmtQuery(queryFmtRevokeOAuth2Session, tableOAuth2AuthorizeCodeSession, name, schema),
		sqlRevokeOAuth2AuthorizeCodeSessionByRequestID:     fmtQuery(queryFmtRevokeOAuth2SessionByRequestID, tableOAuth2AuthorizeCodeSession, name, schema),
		sqlDeactivateOAuth2AuthorizeCodeSession:            fmtQuery(queryFmtDeactivateOAuth2Session, tableOAuth2AuthorizeCodeSession, name, schema),
		sqlDeactivateOAuth2AuthorizeCodeSessionByRequestID: fmtQuery(queryFmtDeactivateOAuth2SessionByRequestID, tableOAuth2AuthorizeCodeSession, name, schema),

		sqlInsertOAuth2OpenIDConnectSession:                fmtQuery(queryFmtInsertOAuth2Session, tableOAuth2OpenIDConnectSession, name, schema),
		sqlSelectOAuth2OpenIDConnectSession:                fmtQuery(queryFmtSelectOAuth2Session, tableOAuth2OpenIDConnectSession, name, schema),
		sqlRevokeOAuth2OpenIDConnectSession:                fmtQuery(queryFmtRevokeOAuth2Session, tableOAuth2OpenIDConnectSession, name, schema),
		sqlRevokeOAuth2OpenIDConnectSessionByRequestID:     fmtQuery(queryFmtRevokeOAuth2SessionByRequestID, tableOAuth2OpenIDConnectSession, name, schema),
		sqlDeactivateOAuth2OpenIDConnectSession:            fmtQuery(queryFmtDeactivateOAuth2Session, tableOAuth2OpenIDConnectSession, name, schema),
		sqlDeactivateOAuth2OpenIDConnectSessionByRequestID: fmtQuery(queryFmtDeactivateOAuth2SessionByRequestID, tableOAuth2OpenIDConnectSession, name, schema),

		sqlInsertOAuth2PKCERequestSession:                fmtQuery(queryFmtInsertOAuth2Session, tableOAuth2PKCERequestSession, name, schema),
		sqlSelectOAuth2PKCERequestSession:                fmtQuery(queryFmtSelectOAuth2Session, tableOAuth2PKCERequestSession, name, schema),
		sqlRevokeOAuth2PKCERequestSession:                fmtQuery(queryFmtRevokeOAuth2Session, tableOAuth2PKCERequestSession, name, schema),
		sqlRevokeOAuth2PKCERequestSessionByRequestID:     fmtQuery(queryFmtRevokeOAuth2SessionByRequestID, tableOAuth2PKCERequestSession, name, schema),
		sqlDeactivateOAuth2PKCERequestSession:            fmtQuery(queryFmtDeactivateOAuth2Session, tableOAuth2PKCERequestSession, name, schema),
		sqlDeactivateOAuth2PKCERequestSessionByRequestID: fmtQuery(queryFmtDeactivateOAuth2SessionByRequestID, tableOAuth2PKCERequestSession, name, schema),

		sqlInsertOAuth2RefreshTokenSession:                fmtQuery(queryFmtInsertOAuth2Session, tableOAuth2RefreshTokenSession, name, schema),
		sqlSelectOAuth2RefreshTokenSession:                fmtQuery(queryFmtSelectOAuth2Session, tableOAuth2RefreshTokenSession, name, schema),
		sqlRevokeOAuth2RefreshTokenSession:                fmtQuery(queryFmtRevokeOAuth2Session, tableOAuth2RefreshTokenSession, name, schema),
		sqlRevokeOAuth2RefreshTokenSessionByRequestID:     fmtQuery(queryFmtRevokeOAuth2SessionByRequestID, tableOAuth2RefreshTokenSession, name, schema),
		sqlDeactivateOAuth2RefreshTokenSession:            fmtQuery(queryFmtDeactivateOAuth2Session, tableOAuth2RefreshTokenSession, name, schema),
		sqlDeactivateOAuth2RefreshTokenSessionByRequestID: fmtQuery(queryFmtDeactivateOAuth2SessionByRequestID, tableOAuth2RefreshTokenSession, name, schema),

		sqlInsertMigration:       fmtQuery(queryFmtInsertMigration, tableMigrations, name, schema),
		sqlSelectMigrations:      fmtQuery(queryFmtSelectMigrations, tableMigrations, name, schema),
		sqlSelectLatestMigration: fmtQuery(queryFmtSelectLatestMigration, tableMigrations, name, schema),

		sqlUpsertEncryptionValue: fmtQuery(queryFmtUpsertEncryptionValue, tableEncryption, name, schema),
		sqlSelectEncryptionValue: fmtQuery(queryFmtSelectEncryptionValue, tableEncryption, name, schema),
	}
