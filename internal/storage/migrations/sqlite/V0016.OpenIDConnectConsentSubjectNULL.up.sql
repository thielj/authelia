...
CREATE TABLE IF NOT EXISTS _bkp_up_V0016_oauth2_consent_preconfiguration (
...
INSERT INTO _bkp_up_V0016_oauth2_consent_preconfiguration (client_id, subject, created_at, expires_at, revoked, scopes, audience)
...
SELECT client_id, subject, created_at, expires_at, revoked, scopes, audience
FROM _bkp_up_V0016_oauth2_consent_preconfiguration
ORDER BY id;

DROP TABLE IF EXISTS _bkp_up_V0016_oauth2_consent_preconfiguration;
